    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          res = _context.sent;
          orders = res.data;
          if (orders && _typeof(orders) == "object" && orderTableBody) {
...
function placeOrder(formDataObject) {
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].post("/order", formDataObject).then(function (res) {
...
var elements = document.querySelectorAll(".status_line");
if (elements) {
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var stripe, card, mountWidget, paymentType, orderForm;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_0__.loadStripe)("pk_test_51Nsdy9Ls04WqLZIQwjPqrBIk0FecSTZpSorYrBujnOQxoEgdRtT1l3QDKXC1YIXPfqjJnWWVHPReRGEN8yi7HV4s00nqxEGCWh");
        case 3:
        ...
        case 8:
          ...
          if (orderForm) {
            orderForm.addEventListener("submit", function (e) {
              ...
              if (!card) {
                (0,_apiService__WEBPACK_IMPORTED_MODULE_1__.placeOrder)(formDataObject);
                return;
              }
